...
const navbar = () => {    
    ...
    return (
            <div id='navbar' class="z-50 flex fixed top-0 left-0 right-0 lg:justify-between xs:justify-start border-b bg-black text-white">
                <div class="font-medium sm:w-1/3 sm:text-left m-4 sm:ml-10 sm:text-4xl xs:text-2xl 2xs:text-xl 2xs:w-screen 2xs:text-center">
                    <a href="#">Niels Feijen</a>
                </div>
                <div class='mt-5 sm:text-xl 2xs:text-base text-center text-portfolioGray sm:block 2xs:hidden sm:w-1/3 xs:w-auto sm:ml-0 xs:ml-4'>
